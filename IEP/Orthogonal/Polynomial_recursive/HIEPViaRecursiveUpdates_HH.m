function [Q,H] = HIEPViaRecursiveUpdates_HH(z,w)
% Solves Hessenberg IEP with a recursive strategy and Householder transformations
...
for i = 1:log2(m)
  for j = 1:2^i:m
    ...
    [Q([ind(1):ind(end)],[ind(1):ind(end)]), H([ind(1):ind(end)],[ind(1):ind(end)])]= mergeIEP_HH(Q1,Q2,H1,H2,w1,w2);
